        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              <img src="/line.png w-20 -left-6 -bottom-6 select-none" alt="" />
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:max-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "The case feels durable and I even got a compliment on the design. Had the case for a half months now 
                  and  <span className="p-0.5 bg-slate-800 text-white"> the Image is super clear </span>, on the case I had before, the image started fading into yellow-ish color
              ...
              <div className="flex gap-4 mt-2">
                <img src="/users/user-1.png" className="rounded-full object-cover h-12 w-12" alt="user" />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  "I usually keep my phone together with my keys in my pocket and that led to some pretty heavy scratchmark on all of
                  my last phone cases. This one, besides a barely noticebale scratch on the corner, <span className="p-0.5 bg-slate-800 text-white"> looks brand new after about half a year </span>
                  , I dig it.
                  "
                </p>
              </div>
              ...
              <div className="flex gap-4 mt-2">
                <img src="/users/user-4.jpg" className="rounded-full object-cover h-12 w-12" alt="user" />
                <div className="flex flex-col">
